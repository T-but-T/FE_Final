...
export default function AdminRestaurants() {
  ...
  const handleEditToggle = (id: string) => {
    setRestaurants(
      restaurants.map((r) => (r.id === id ? { ...r, isEditing: true } : r)),
    );
  };
  ...
  const handleSave = async (id: string) => {
    ...
    const url = shopToUpdate.isNew
      ? `${API_URL}/restaurants`
      : `${API_URL}/restaurants/${shopToUpdate._id}`;
    ...
    try {
      ...
      alert(
        shopToUpdate.isNew ? "Created Successfully!" : "Update Successful!",
      );
    ...
    if (window.confirm("Are you sure you want to delete this restaurant?")) {
      try {
        ...
        const response = await fetch(
          `${API_URL}/restaurants/${shopToDelete._id}`,
          {
            method: "DELETE",
  ...
  if (loading)
    return (
      <div className="min-h-screen bg-white flex items-center justify-center text-black font-bold">
        Loading Admin Panel...
      </div>
    );
        ...
        <div className="w-full max-w-5xl bg-[#E5E5E5] rounded-xl p-10 shadow-lg min-h-[500px]">
          ...
          <div className="bg-white border border-gray-300 rounded-lg max-h-[600px] overflow-y-auto p-8 shadow-inner">
            {restaurants.map((shop) => (
              <div
                key={shop.id}
                className="flex flex-col md:flex-row gap-8 bg-[#F9F9F9] p-6 border border-gray-200 rounded-xl mb-6 shadow-sm relative"
              >
                ...
                <div className="flex-1 space-y-3">
                  {shop.isEditing ? (
                    <input
                      ...
                      value={shop.name}
                      onChange={(e) =>
                        handleChange(shop.id, "name", e.target.value)
                      }
                  ...
                  {shop.isEditing ? (
                    <div className="grid grid-cols-1 gap-3 text-sm">
                      <input
                        className="border border-gray-300 p-2.5 rounded-md bg-white focus:ring-2 focus:ring-blue-200 outline-none"
                        value={shop.address}
                        onChange={(e) =>
                          handleChange(shop.id, "address", e.target.value)
                        }
                        placeholder="Address"
                      />
                      <input
                        ...
                        onChange={(e) =>
                          handleChange(shop.id, "description", e.target.value)
                        }
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <input
                          ...
                          value={shop.tel}
                          onChange={(e) =>
                            handleChange(shop.id, "tel", e.target.value)
                          }
                        ...
                        <input
                          ...
                          value={shop.region || ""}
                          onChange={(e) =>
                            handleChange(shop.id, "region", e.target.value)
                          }
                          placeholder="Region (e.g., Bangkok)"
                        />
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                        <input
                          ...
                          value={shop.district || ""}
                          onChange={(e) =>
                            handleChange(shop.id, "district", e.target.value)
                          }
                        ...
                        <input
                          ...
                          value={shop.province || ""}
                          onChange={(e) =>
                            handleChange(shop.id, "province", e.target.value)
                          }
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleChange(shop.id, "postalcode", e.target.value)
                          }
                      ...
                      <div className="flex gap-3">
                        <input
                          className="border border-gray-300 p-2.5 rounded-md bg-white w-1/2 focus:ring-2 focus:ring-blue-200 outline-none"
                          value={shop.openTime}
                          onChange={(e) =>
                            handleChange(shop.id, "openTime", e.target.value)
                          }
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleChange(shop.id, "closeTime", e.target.value)
                          }
                    ...
                    <div className="text-sm text-gray-700 space-y-2">
                      <p>
                        ...
                        {shop.address} {shop.district} {shop.province}{" "}
                        {shop.postalcode}
                      </p>
                      <p>
